...
./build/kernel64.o: ./src/kernel/kernel64.cpp ./src/kernel/core/kernel64_main.cpp ./src/kernel/core/kernel64_process.cpp ./src/kernel/core/kernel64_diag.cpp ./src/kernel/core/kernel64_user.cpp ./src/kernel/core/kernel64_irq.cpp ./src/include/drivers/gop.h
...
./build/ksh64.o: ./src/kernel/ksh64.cpp ./src/include/kernel/pci.h ./src/include/drivers/gop.h
...
./build/driver_unload64.o: ./src/kernel/driver/driver_unload.cpp ./src/include/kernel/driver/driver_manager.h ./src/include/kernel/driver/drv_format.h
	$(HOST64_CXX) $(HOST64_CPPFLAGS) -Os -c ./src/kernel/driver/driver_unload.cpp -o ./build/driver_unload64.o

./build/driver_builtin64.o: ./src/kernel/driver/driver_builtin.cpp ./src/include/kernel/driver/driver_manager.h ./src/include/drivers/gop.h
...
./build/kernel_exports64.o: ./src/kernel/driver/kernel_exports.cpp ./src/include/kernel/driver/kernel_exports.h ./src/include/kernel/driver/driver_manager.h ./src/include/kernel/pci.h ./src/include/arch/x86/io.h ./src/include/drivers/ata.h ./src/include/drivers/gop.h ./src/include/fs/vfs.h
...
./build/gop64.o: ./src/drivers/gop.cpp ./src/include/drivers/gop.h ./src/include/kernel/boot_info.h
	$(HOST64_CXX) $(HOST64_CPPFLAGS) -Os -c ./src/drivers/gop.cpp -o ./build/gop64.o
...
./bin/kernel64.elf: ./build/kernel64_entry.o ./build/kernel64.o ./build/kutil64.o ./build/kernel_diag64.o ./build/process64.o ./build/userprog64.o ./build/syscall64.o ./build/ksh64.o ./build/driver_manager64.o ./build/driver_exports64.o ./build/driver_loader64.o ./build/driver_unload64.o ./build/driver_builtin64.o ./build/driver_shell64.o ./build/kernel_exports64.o ./build/pci64.o ./build/terminal64.o ./build/gop64.o ./build/ata64.o ./build/fat32_64.o ./build/fat32_vfs64.o ./build/vfs64.o ./build/keyboard64.o ./build/pit64.o ./build/idt64.o ./build/idt64_asm.o ./build/gdt64.o ./build/gdt64_asm.o ./build/user64_asm.o ./build/pmm64.o ./build/paging64.o ./build/heap64.o
