...
./build/driver_loader64.o: ./kernel/driver/driver_loader.cpp ./include/kernel/driver/driver_manager.h ./include/kernel/driver/driver_va.h ./include/kernel/driver/drv_format.h
	$(HOST64_CXX) $(HOST64_CPPFLAGS) -Os -c $< -o $@

./build/driver_unload64.o: ./kernel/driver/driver_unload.cpp ./include/kernel/driver/driver_manager.h ./include/kernel/driver/driver_va.h ./include/kernel/driver/drv_format.h
	$(HOST64_CXX) $(HOST64_CPPFLAGS) -Os -c $< -o $@
...
./build/driver_shell64.o: ./kernel/driver/driver_shell.cpp ./include/kernel/driver/driver_manager.h ./include/kernel/driver/driver_va.h
	$(HOST64_CXX) $(HOST64_CPPFLAGS) -Os -c $< -o $@
