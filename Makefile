...
USER_SDK_HEADERS = $(wildcard ./user/sdk/include/os64/*.h) $(wildcard ./user/sdk/src/*.h) ./include/os64/input_types.h ./include/os64/ipc_types.h ./include/os64/service_types.h ./include/os64/service_manager_types.h
...
.PHONY: all all64 uefi uefi-diagnostic drivers test-user-sdk test-phase1 test-shutdown test-graphics test-graphics-contracts test-graphics-demo test-gop-present test-graphics-clip test-input test-input-queue test-input-event-loop test-ipc-contracts test-ipc-smoke test-ipc test-service-registry test-service-smoke test-service-manager-smoke test-services clean
...
test-services: test-service-registry test-service-smoke test-service-manager-smoke
