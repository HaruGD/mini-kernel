...
#define VM_KERNEL_SURFACE_BASE 0x0000000078000000ULL
#define VM_KERNEL_SURFACE_LIMIT 0x0000000080000000ULL

#define VM_USER_SURFACE_BASE  0x0000000010000000ULL
#define VM_USER_SURFACE_LIMIT 0x0000000018000000ULL
