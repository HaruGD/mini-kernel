...
#define SYS_ERR_NOT_FOUND (-3)
#define SYS_ERR_BUFFER_TOO_SMALL (-4)
#define SYS_ERR_IO (-5)
#define SYS_ERR_ALREADY_EXISTS (-6)
#define SYS_ERR_NO_RESOURCES (-7)
#define SYS_ERR_UNSUPPORTED (-8)
...
#define SYS_ERR_TIMEOUT (-17)
#define SYS_ERR_CANCELLED (-18)
