...
static const uint8_t FONT_LOWERCASE[26][FONT_HEIGHT] = {
...
static uint8_t glyph_row(uint32_t codepoint, uint32_t row) {
    ...
    if (character >= 'a' && character <= 'z') {
        return FONT_LOWERCASE[character - 'a'][row];
    }
    if (character >= 'A' && character <= 'Z') {
    ...
    switch (character) {
        case ' ': return 0;
        case '!': return (uint8_t[]){0x04,0x04,0x04,0x04,0x04,0,0x04}[row];
        case '"': return (uint8_t[]){0x0A,0x0A,0x0A,0,0,0,0}[row];
        case '#': return (uint8_t[]){0x0A,0x1F,0x0A,0x0A,0x1F,0x0A,0}[row];
        case '$': return (uint8_t[]){0x04,0x0F,0x14,0x0E,0x05,0x1E,0x04}[row];
        case '%': return (uint8_t[]){0x19,0x1A,0x04,0x08,0x0B,0x13,0}[row];
        case '&': return (uint8_t[]){0x0C,0x12,0x14,0x08,0x15,0x12,0x0D}[row];
        case '\'': return (uint8_t[]){0x04,0x04,0x08,0,0,0,0}[row];
        case '(': return (uint8_t[]){0x02,0x04,0x08,0x08,0x08,0x04,0x02}[row];
        case ')': return (uint8_t[]){0x08,0x04,0x02,0x02,0x02,0x04,0x08}[row];
        case '*': return (uint8_t[]){0,0x15,0x0E,0x1F,0x0E,0x15,0}[row];
        case '+': return (uint8_t[]){0,0x04,0x04,0x1F,0x04,0x04,0}[row];
        case ',': return (uint8_t[]){0,0,0,0,0,0x04,0x08}[row];
        ...
        case ';': return (uint8_t[]){0,0,0x04,0,0x04,0x04,0x08}[row];
        case '<': return (uint8_t[]){0x01,0x02,0x04,0x08,0x04,0x02,0x01}[row];
        case '=': return (uint8_t[]){0,0x1F,0,0x1F,0,0,0}[row];
        case '>': return (uint8_t[]){0x10,0x08,0x04,0x02,0x04,0x08,0x10}[row];
        case '?': return (uint8_t[]){0x0E,0x11,0x01,0x02,0x04,0,0x04}[row];
        ...
        case '^': return (uint8_t[]){0x04,0x0A,0x11,0,0,0,0}[row];
        case '_': return row == 6 ? 0x1F : 0;
        case '`': return (uint8_t[]){0x08,0x04,0x02,0,0,0,0}[row];
        case '{': return (uint8_t[]){0x03,0x04,0x04,0x08,0x04,0x04,0x03}[row];
        case '|': return (uint8_t[]){0x04,0x04,0x04,0x04,0x04,0x04,0x04}[row];
        case '}': return (uint8_t[]){0x18,0x04,0x04,0x02,0x04,0x04,0x18}[row];
        case '~': return (uint8_t[]){0,0,0x09,0x16,0,0,0}[row];
