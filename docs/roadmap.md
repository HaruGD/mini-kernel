...
1. Phase 2 graphics contracts (`G01`~`G04`)
2. 2D drawing primitives (`G05`~`G11`)
3. Double buffering (`G12`~`G17`)
4. Input event queue (`I01`~`I08`)
5. Process event delivery (`P01`~`P05`)
6. Phase 2 regression closure (`T01`~`T04`)
7. IPC core
8. Framebuffer compositor prototype
