...
| --- | --- | --- | --- | --- | --- |
| P5-R01 | 5A | One generation-owned graphical session controls startup, shutdown, and recovery. | `make test-desktop-session` | Ordered start/stop, duplicate requests, stale generations, service crashes, restart exhaustion, and console fallback are deterministic. | Planned |
